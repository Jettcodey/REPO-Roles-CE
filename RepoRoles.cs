...
{
	internal static RepoRoles? Instance { get; private set; }
	internal static new ManualLogSource? Logger { get; private set; }

	private readonly Harmony harmony = new Harmony("Repo_Roles");
		...
		MenuAPI.AddElementToSettingsMenu((BuilderDelegate)delegate (Transform parent)
		{
			...
			configPage.AddElementToScrollView(delegate (Transform scrollView)
			{
				if ((UnityEngine.Object)(object)slider == null)
				{
					...
					{
						sliderConf(s);
					}, scrollView, ["Random", "Runner", "Tank", "Gambler", "Strongman", "Ranged Looter", "Athletic", "Mage", "Reaper", "Scout"], savedRole.Value, new Vector2(0f, 0f), "", "", (BarBehavior)0);
				}
